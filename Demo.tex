...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item Can also highlight with a \stabilo[Blue_Light]{custom color} too using \texttt{\textbackslash stabilo[\textit{color}]\{\textit{text}\}}\bigskip\bigskip
        \end{itemize}
        \item Or \lapis{highlight text} using the pencil-like \texttt{\textbackslash lapis\{\textit{text}\}} command \medskip
        \begin{itemize}
            \item Can also highlight with a \lapis[Blue_Light]{custom color} \ too using \texttt{\textbackslash stabilo[\textit{color}]\{\textit{text}\}}\bigskip\bigskip
        \end{itemize}
        \item You have more control using Tikz directly, for example \medskip
        \begin{itemize}
            \item \tikz[tstyle]{\node[nstyle](node2){Highlight text with a thinner pencil}}
            \begin{tikzpicture}[tpstyle]
