...
\begin{frame}
	{Highlighting}
	\begin{itemize}
		\item \stabilo{Highlight text} with the \texttt{stabilo} command  \medskip
        \begin{itemize}
            \item Can also highlight with a \stabilo[Blue_Light]{custom color} too using \texttt{stabilo[color]\{text\}}
        \end{itemize}\bigskip
		...
		\begin{itemize}
			...
			\end{tikzpicture}  \bigskip \pause
			\item or use the \texttt{lapis[color]\{text\}} command to \lapis[purple]{highlight with a thick pencil and a custom color} \bigskip \pause
			\item When used without color \texttt{lapis\{text\}} uses the base \lapis{gold color}
		\end{itemize}
	\end{itemize}
\end{frame}
%.......................................................
