...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \begin{equation*}
            y_{t} = \alpha + \lapisboxeq[color=tomato,label=box1]{\beta x_t} + u_{t} \vspace{-.3cm}
        \end{equation*}
        \pause
...
%=============================================================
\begin{frame}
    {Theme's options (cont'd)}
    \begin{itemize}
        \item \dots\ and a few more that control layout and behaviour
        \begin{itemize}
            ...
            \item \texttt{centertitle}: center frame titles across the page (default is left-aligned)
            \item \texttt{wiggle=<n>}: set the amplitude of the pencil/sketch effect globally (or ad-hoc with \texttt{\textbackslash jambrowiggleamp\{\textit{dimen}\}})
...
\begin{frame}
    {Theme's options}
    \begin{itemize}
        \item Set \texttt{centertitle} to center frame titles across the page (default is left-aligned)
    \end{itemize}
    \begin{center}
        \begin{minipage}[b]{.6\textwidth}
            \includegraphics[width=\textwidth]{centertitle}
        \end{minipage}
    \end{center}
\end{frame}
%.......................................................
...
\begin{frame}
    {Theme's options}
    \begin{itemize}
        \item Set \texttt{wiggle=<n>} to control the amplitude of the pencil/sketch effect; larger is more expressive (here \texttt{wiggle=12} vs.\ default \texttt{0.4})
    \end{itemize}
    \begin{center}
        \begin{minipage}[b]{.6\textwidth}
            \includegraphics[width=\textwidth]{wiggle}
        \end{minipage}
    \end{center}
\end{frame}
%.......................................................
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Math shorthand \texttt{\textbackslash EE} for $\mathbb{E}$: write $\EE[x_t \mid \mathcal{F}_{t-1}]$ instead of \texttt{\$\textbackslash mathbb\{E\}\$}\bigskip
...
\begin{frame}
    ...
    \begin{itemize}
        \item The amplitude of the pencil sketch effect can be set two ways
        \begin{itemize}
            \item Document-wide via the option \texttt{\textbackslash documentclass[wiggle=\textit{n}]\{beamer\}} or \texttt{\textbackslash usetheme[wiggle=\textit{n}]\{jambro\}} (default: 0.4)
            \item Ad-hoc via \texttt{\textbackslash jambrowiggleamp\{\textit{dimen}\}}, e.g.\ in the preamble, or inside a group to override locally (as below)
        \end{itemize}\bigskip
        \item The effect on underlines and boxes:
    \end{itemize}
    \begin{center}
        \jambrowiggleamp{0.2pt}%
        \lapis{subtle (0.2pt)} \quad \lapisbox{box (0.2pt)} \quad
    \end{center}
    \begin{center}
        \jambrowiggleamp{0.4pt}%
        \lapis{default (0.4pt)} \quad \lapisbox{box (0.4pt)} \quad
    \end{center}
    \begin{center}
        \jambrowiggleamp{2.5pt}%
        \lapis{expressive (2.5pt)} \quad \lapisbox{box (2.5pt)} \quad
    \end{center}
\end{frame}
%.......................................................
\shownotesblock{}
